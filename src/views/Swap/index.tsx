...
const SwapPage = () => {
    ...
    useEffect(() => {
        if (Number(allowance) >= Number(state.from)) setIsApproved(true);
    ...
    const handleMaxClick = () => {
        if (from.key === "safuu") {
            ...
            if (Number(bnbBalance) >= 0.005) setState({ from: Number(bnbBalance) - 0.005, to: trim(amount_out, 5) });
            else setState({ from: 0, to: trim(amount_out, 5) });
        }
    };
                ...
                <div className="swap-content">
                    <div className="swap-header">
                        <div className="main-header">
                            <h2>Create a Market and Snipe on Raydium</h2>
                        </div>
                        <div className="sub-header">Fast, Secure</div>
                    </div>
                    <div>
                        <div className="setting-status">
                            <p>Check the balances of admin wallets</p>
                        </div>

                        <div className="swap-button">Check the balance</div>

                        <div className="swap-details">
                            <p>
                                <span>Admin Wallet 1:</span>
                                <span>{trim(Number(state.to) * (1 - slip), 5)} USDT</span>
                            </p>
                            <p>
                                <span>Admin Wallet 2:</span>
                                <span>{trim(Number(state.to) * (1 - slip), 5)} USDT</span>
                            </p>
                            <p>
                                <span>Admin Wallet 3:</span>
                                <span>{trim(Number(state.to) * (1 - slip), 5)} USDT</span>
                            </p>
                            <p>
                                <span>Admin Wallet 4:</span>
                                <span>{trim(Number(state.to) * (1 - slip), 5)} USDT</span>
                            </p>
                        </div>
                        <div className="snipe-button">Creat a Market & Snipe</div>
                    </div>
                </div>
            </div>
                ...
                <Box sx={swapStyle}>
                    ...
                    <div className="swap-details">
                        <p>
                            ...
                            <span>
                                {trim(Number(state.to) * (1 - slip), 5)} {to.label}
                            </span>
                        </p>
                        <p>
                            <span>
