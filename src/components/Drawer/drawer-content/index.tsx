...
import LogoImg from "../../../assets/icons-safuu/sol-logo.svg";
            ...
            <div>
                ...
                <div className="dapp-menu-links">
                    <div className="dapp-nav">
                        ...
                        {/* <Link href="https://safuuprotocol.gitbook.io/safuuprotocol/" target="_blank" className={classnames("button-dapp-menu", { active: isActive })}>
                            <div className="dapp-menu-item">
